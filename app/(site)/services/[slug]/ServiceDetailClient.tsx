...
import type { getServiceBySlug, getServices } from '@/lib/data/services';
import { getWhatsAppUrl } from '@/lib/utils';

type Service = NonNullable<Awaited<ReturnType<typeof getServiceBySlug>>>;
type RelatedService = Awaited<ReturnType<typeof getServices>>[number];
...
export default function ServiceDetailClient({ service, related, whatsapp, phone }: Props) {
